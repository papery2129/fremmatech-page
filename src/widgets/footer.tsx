export const Footer = () => {
  ...
  return (
    <footer className="bg-#0e0e0f py-20 border-t border-white/5 opacity-90 hover:opacity-100 transition-opacity">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <p className="font-body text-base text-on-surface-variant max-w-sm leading-relaxed">
            Somos tu aliado estratégico en tecnología. Diseñamos, implementamos y gestionamos soluciones IT que impulsan el crecimiento de tu negocio.
          </p>
        </div>
        ...
        <div>
          ...
          <nav aria-label="Navegación de servicios del pie de página">
            <ul className="space-y-4 font-body text-base text-on-surface-variant">
              <li>
                <a href="#soluciones" className="hover:text-secondary-container transition-colors focus:outline-none focus:ring-2 focus:ring-cyan-400 rounded-sm">
        ...
        <div>
          ...
          <address className="not-italic">
            <ul className="space-y-4 font-body text-base text-on-surface-variant">
              <li>
                {/* Protocolo mailto para delegar la apertura segura al cliente de correo del SO */}
              ...
              <li>
                {/* Protocolo tel para facilitar la llamada directa en dispositivos móviles */}
